...
class VanInvoice(QWidget):
    def __init__(self):
        ...
        loadUi("Demo/Demo UI/new.ui",self)
        self.show()
    ...
    def reprintBut(self):  
        ...
        try:
            ...
            df2 = DBF('Demo/Demo Data/pr_sysky.dbf', char_decode_errors='replace')
            ...
            if ftype == 'INV':
                ...
                df = DBF('Demo/Demo Data/pri_hd.dbf', char_decode_errors='replace')
                framei = DataFrame(iter(df))
                framei.to_sql(name='pri_hd', con=conn, if_exists='append')

                df1 = DBF('Demo/Demo Data/pri_det.dbf', char_decode_errors='replace')
                ...
                finame = "d_i"+ str(rinvnum)
                
            
            elif ftype == 'QU':
                df = DBF('Demo/Demo Data/prq_hd.dbf', char_decode_errors='replace')
                framei = DataFrame(iter(df))
                framei.to_sql(name='prq_hd', con=conn, if_exists='append')

                df1 = DBF('Demo/Demo Data/prq_det.dbf', char_decode_errors='replace')
                frame1 = DataFrame(iter(df1))
                ...
                if d == [(None, None, None)]:
                    d=[(0.00,0.00,0.00)]
                finame = "d_q"+ str(rquote)
            
            elif ftype=="WO": 
                df = DBF('Demo/Demo Data/prw_hd.dbf', char_decode_errors='replace')
                framei = DataFrame(iter(df))
                framei.to_sql(name='prw_hd', con=conn, if_exists='append')

                df1 = DBF('Demo/Demo Data/prw_det.dbf', char_decode_errors='replace')
                frame1 = DataFrame(iter(df1))
            ...
            save_name = os.path.join("Demo/Demo PDF Files/", finame+'.pdf')           
    ...
    def toPDF(self):
        ...
        try:
            ...
            for data, sumamt, ogst, ototal, odate, osale, oadd, oinv, oquo, oname, osadd1, osadd2, osadd3, oscode, osphone, ospstno, olstr, olname, oladd1, oladd2, oladd3, olcode in zip(all_data, amt, gst, total, date, saleman,addedby,invnum,quote, name, sadd1, sadd2, sadd3, scode, sphone, spstno, lstreet, lname, ladd1, ladd2, ladd3, lcode):
                ...
                save_name = os.path.join("Demo/Demo PDF Files/", "d_i"+ str(oinv)+'.pdf')           
                doc = BaseDocTemplate(save_name, leftMargin=0.5 * inch, rightMargin=0.5 * inch)              
                frame = Frame(
            ...
            try:               
                opentable = dbf.Table('Demo/Demo Data/pri_hd.dbf')
...
class Welcome(QWidget):
     def __init__(self):
        ...
        loadUi("Demo/Demo UI/welcome.ui",self)
        self.show() 
...
class Step1(QWidget):
     def __init__(self):
        ...
        loadUi("Demo/Demo UI/s1.ui",self)
        self.show()
        self.setWindowFlag(Qt.FramelessWindowHint)
        self.btn_close.clicked.connect(self.close)
...
class Step2(QWidget):
     def __init__(self):
        ...
        loadUi("Demo/Demo UI/s2.ui",self)
        self.show()
        self.setWindowFlag(Qt.FramelessWindowHint)
        self.btn_close.clicked.connect(self.close)
        self.btn_skip.clicked.connect(self.close)
...
class Step3(QWidget):
     def __init__(self):
        ...
        loadUi("Demo/Demo UI/s3.ui",self)
        self.show()
        self.setWindowFlag(Qt.FramelessWindowHint)
        self.btn_close.clicked.connect(self.close)
        self.btn_skip.clicked.connect(self.close)
...
class Step4(QWidget):
     def __init__(self):
        ...
        loadUi("Demo/Demo UI/s4.ui",self)
        self.show()
        self.setWindowFlag(Qt.FramelessWindowHint)
        self.btn_close.clicked.connect(self.close)
        self.btn_skip.clicked.connect(self.close)
...
class Step5(QWidget):
     def __init__(self):
        ...
        loadUi("Demo/Demo UI/s5.ui",self)
        self.show()
        self.setWindowFlag(Qt.FramelessWindowHint)
        self.btn_close.clicked.connect(self.close)
        self.btn_skip.clicked.connect(self.close)
...
class Step6(QWidget):
     def __init__(self):
        ...
        loadUi("Demo/Demo UI/s6.ui",self)
        self.show()
        self.setWindowFlag(Qt.FramelessWindowHint)
        self.btn_close.clicked.connect(self.close)
        self.btn_back.clicked.connect(self.back)
